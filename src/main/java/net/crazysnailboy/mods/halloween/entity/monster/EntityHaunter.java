...
//		}
	...
	/**
	 * Overridden so the Haunter doesn't take fall damage
	 */
	@Override
...
// ====================================================================================================
// Everything below here is redundant code adapted from KodaichiZero's original,
// kept for future reference to improve Haunter behaviour.
//
// ====================================================================================================
//
...
//
//	/**
//	 * Code from the original Haunter's {@link EntityLiving#updateEntityActionState()} method.
//	 */
//	private void _updateEntityActionState()
//	{
